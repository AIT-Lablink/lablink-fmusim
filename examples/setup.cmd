...
SET FMUSIM_JAR_FILE=%FMUSIM_ROOT_DIR%\target\assembly\fmusim-%VERSION%-jar-with-dependencies.jar 
...
SET DPB_JAR_FILE=%FMUSIM_ROOT_DIR%\target\dependency\dpbridge-0.0.2-jar-with-dependencies.jar

REM Path to Java JAR file of data plotter.
SET PLOT_JAR_FILE=%FMUSIM_ROOT_DIR%\target\dependency\plotter-0.0.4-jar-with-dependencies.jar

REM Path to Java JAR file of config server.
SET CONFIG_JAR_FILE=%FMUSIM_ROOT_DIR%\target\dependency\config-0.1.1-jar-with-dependencies.jar
