...
/**
 * Class StringInputDataNotifier.
 */
public class StringInputDataNotifier implements IServiceStateChangeNotifier<LlService, String> {
   ...
   */
  public StringInputDataNotifier( FmuSimBase fmu, int pos ) {
    fmuSim = fmu;
    position = pos;
  }
  ...
  public void stateChanged( LlService service, String oldVal, String newVal ) {
    ...
    fmuSim.setStringInput( newVal, position );
